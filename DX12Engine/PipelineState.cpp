...
void GraphicsPSO::Finalize()
{
    ...
    if (firstCompile)
    {
        ASSERT_SUCCEEDED( gCore->mDevice->CreateGraphicsPipelineState(&m_PSODesc, MY_IID_PPV_ARGS(&m_PSO)) );
...
void ComputePSO::Finalize()
{
    ...
    if (firstCompile)
    {
        ASSERT_SUCCEEDED( gCore->mDevice->CreateComputePipelineState(&m_PSODesc, MY_IID_PPV_ARGS(&m_PSO)) );
